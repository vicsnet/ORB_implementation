...
pub mod ORBInvocationRegistry {
    ...
    #[derive(Drop, starknet::Event)]
    pub struct ResponseFlagging {
        #[key]
        pub orb_address: ContractAddress,
        pub invocation_id: u256,
        pub flager: ContractAddress
    }
    #[derive(Drop, starknet::Event)]
    pub struct PositiveRating {
        #[key]
        pub orb_address: ContractAddress,
        pub invocation_id: u256,
        pub usage_level: u256,
    ...
    impl OrbInvocationRegistry of super::IOrbInvocationRegistryTrait<ContractState> {
        ...
        fn invoke_with_hash(
            ...
            assert(
                current_time > IORBDispatcher { contract_address }
                    .my_last_invocation_time(token_id_)
        ...
        fn flag_response(
            ...
            assert(
                self.response_rating.read((contract_address, invocation_id_)) == false,
                'POSITIVE_RATED'
            );
