...
#[starknet::contract]
mod ORB_pond {
    use starknet::{ContractAddress, ClassHash, SyscallResultTrait, syscalls::deploy_syscall, get_caller_address};
...
fn set_orb_initial_version(ref self: ContractState, orb_initial_version_:u256 ) {
    ...
    self.orb_initial_version.write(orb_initial_version_);
